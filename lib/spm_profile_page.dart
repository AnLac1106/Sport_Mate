                          ...
                          Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SPMAvatarBox(
                                      image: NetworkImage(
                                          'https://vnn-imgs-f.vgcloud.vn/2020/04/23/12/messi.jpg'),
                                      diameter: 55,
                                    ),
                                    const SizedBox(width: 20),
                                    Expanded(
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const SPMAvatarBox(
                                  image: NetworkImage(
                                      'https://nld.mediacdn.vn/291774122806476800/2022/7/26/hinh-3-16588045625731888728193.jpeg'),
                                  diameter: 55,
                                ),
                                const SizedBox(width: 20),
                                Expanded(
